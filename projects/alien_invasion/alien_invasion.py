...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Alien<<Fight for the love of Plamena Kolewa>>Invasion")
    ...
    def _update_screen(self):
        '''update images on thescreen, and flip to the new screen.'''
        self.screen.fill(self.settings.bg_color)
        self.ship.blitme()
    ...
    def _create_fleet(self):
        ...
        # make an alien
        # create an alien and find the number if aliens in a row
        ...
        avaiable_spce_y = (self.settings.screen_heigh -
                           (3 * alien_height) - ship_height)
        number_rows = avaiable_spce_y // (2 * alien_height)

        # create the full fleet of aliens
        for row_number in range(number_rows):
            # create the first rwo of aliens
    ...
    def _update_aliens(self):
        '''check if the alien is at the edge,
