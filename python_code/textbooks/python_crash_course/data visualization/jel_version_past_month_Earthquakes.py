...
import json
# just imported pandas if you want to print a dataframe use print(df)
# in jupyter only df works as this is the name of de variable.
import pandas as pd
...
data = [{
    ...
    'marker': {
        ...
        'size': 5,
        'color': df['Mag'],
        # Err: Invalid property specified for object of type
        # plotly.graph_objs.scattergeo.Marker: 'colorscales' and 'reversecale'
        # Don't know why :P
        'colorscale': 'icefire',
        'reversescale': True,
