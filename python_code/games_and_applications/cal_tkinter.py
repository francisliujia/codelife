...
Subtraction=Button(cal,padx=18.5,pady=16, bd=8, fg='black',font=('arial', 20, 'bold'),
...
Addition=Button(cal,padx=16,pady=16, bd=8, fg='black',font=('arial', 20, 'bold'),
					text='x', bg = 'powder blue', command=lambda:btnClick('x')).grid(row=3, column=3)
...
Divition=Button(cal,padx=18.5,pady=16, bd=8, fg='black',font=('arial', 20, 'bold'),
